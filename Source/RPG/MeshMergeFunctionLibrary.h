...
struct RPG_API FSkelMeshMergeSectionMapping_BP
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct RPG_API FSkelMeshMergeUVTransform
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct RPG_API FSkelMeshMergeUVTransformMapping
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct RPG_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
...
*/
UCLASS()
class RPG_API UMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
public:
    /**
